        ...
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            ...
            <Link
                ...
                className="text-xs font-mono tracking-wider text-zinc-600 border border-zinc-800 px-3.5 py-1.5 rounded-md hover:border-zinc-600 hover:text-zinc-400 transition-all"
            >
              Admin
            </Link>
          </nav>
